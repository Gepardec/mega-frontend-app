...
import { NgFor, NgIf, NgTemplateOutlet, DatePipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [MatTableModule, MatSortModule, NgFor, NgIf, NgTemplateOutlet, MatButtonModule, MatPaginatorModule, MatIconModule, DatePipe]
})
